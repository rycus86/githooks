...
testShared() {
    ...
    "$GITHOOKS_INSTALL_BIN_DIR/cli" shared add --shared file://"$GH_TEST_TMP/shared/second-shared.git" || exit 5
    ...
    "$GITHOOKS_INSTALL_BIN_DIR/cli" shared remove --shared file://"$GH_TEST_TMP/shared/second-shared.git" || exit 13
    "$GITHOOKS_INSTALL_BIN_DIR/cli" shared remove file://"$GH_TEST_TMP/shared/third-shared.git" || exit 14
